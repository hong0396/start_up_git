...
'Authorization': 'Bearer LLRXYsRb20576jhRwJAKT0sFGEjkQC63IMMQLhktKE5vNn5Yk1',
'Host': 'hq2.itiger.com',
...
url_nsdq='https://hq2.itiger.com/market/quote/NASDAQ?page={}&compare=changeRate&minMarketCap=0&order=desc&deviceId=web20180825_733367&platform=desktop-web&env=Chrome&vendor=web&lang=&appVer=4.1.0'

url_ny='https://hq2.itiger.com/market/quote/NYSE?page={}&compare=changeRate&minMarketCap=0&order=desc&deviceId=web20180825_733367&platform=desktop-web&env=Chrome&vendor=web&lang=&appVer=4.1.0'


url_us='https://hq2.itiger.com/market/quote/AMEX?page={}&compare=changeRate&minMarketCap=0&order=desc&deviceId=web20180825_733367&platform=desktop-web&env=Chrome&vendor=web&lang=&appVer=4.1.0'
