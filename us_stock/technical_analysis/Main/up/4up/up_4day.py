...
def get_laohu_analysis(n, url, li_code,days): 
    ...
    plt.savefig('D:/Git/us_stock/technical_analysis/Main/up/4up/up_data/'+date+"_fig_up_"+str(n)+".png")
    # plt.show()
...
write_csv('D:/Git/us_stock/technical_analysis/Main/up/4up/up_data/record.csv',days_sort_df)
# codee=li_code[:1000]
