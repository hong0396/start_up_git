...
def get_laohu_analysis(n, url, li_code,days): 
    ...
    plt.savefig('D:/Git/us_stock/technical_analysis/Main/up/4up1down1up_limit/month/up_data/'+date+"_fig_up_"+str(n)+".png")
    # plt.show()
...
def get_laohu_analysis_all(n, url, li_code,days): 
    ...
    fig.tight_layout(rect=[0.02,0.02,0.98,0.98], pad=0.2, h_pad=0.2, w_pad=0.2)
    fig.subplots_adjust(wspace =0.2, hspace =0.2)
    plt.savefig('D:/Git/us_stock/technical_analysis/Main/up/4up1down1up_limit/month/up_data/'+date+"_fig_up_all_"+str(n)+".png")
    # plt.show()
...
days_df=get_grow_code(url_month, 5, li_code)
...
write_csv('D:/Git/us_stock/technical_analysis/Main/up/4up1down1up_limit/month/up_data/record.csv',days_sort_df)
# codee=li_code[:1000]
...
for i in range((len(codee)//100)+1):
    ...
    get_laohu_analysis(i, url_month, code_tmp, days_tmp)
    time.sleep(1)
    get_laohu_analysis_all(i, url_month, code_tmp, days_tmp)
