...
select.to_csv(date+'_up_code_date_radio.csv')
select_code.to_csv(date+'_up_code_time_radio.csv')

get_picture(url_day,select_code[select_code['li_5_radio']>0],'fig_5up_radio')
time.sleep(0.1) 
get_picture(url_day,select_code[select_code['li_5_radio']<0],'fig_5down_radio')
